        ...
        <form action="">
            <div class="shadow-sm p-3 mb-5 bg-body rounded">
                <div class="row">
                    <div class="col-xl-12">
                        <div class= "line-auto">
                            <h1 class="h-register-user">ระบบที่ต้องการแก้ไขสิทธิ์การใช้งาน</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ยืนยันแก้ไขคำขอสิทธิ์เข้าใช้งาน</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body text-center">
         <small class="text-danger">* ยืนยันการแก้ไขคำขอสิทธิ์เข้าใช้งานระบบ</small>  
      </div>
      <div class="row">
            <div class="col-xl-12 text-center p-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
          ...
          <div class="row">
               <div class="col-xl-12 text-center">
                     <p>แก้ไขคำขอสิทธิ์เข้าใช้ระบบเสร็จสิ้น</p>
               </div>
          </div>
      </div>
    </div>
